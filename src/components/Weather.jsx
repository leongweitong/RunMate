...
const Weather = () => {
  return (
    <div className="bg-primary_90 p-4 rounded-b-3xl p-4 h-60 mb-20">
        ...
        <div className='bg-white p-4 rounded-3xl shadow'>
            <div className="flex items-center justify-center">
                ...
                <div className="flex-1 text-md">
                    ...
                    <div className='flex text-primary_90 font-bold'>
